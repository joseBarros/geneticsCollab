...
public class NamedEntityResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<NamedEntityDTO>> getAllNamedEntities(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of NamedEntities");
        Page<NamedEntityDTO> page = namedEntityService.findAll(pageable);

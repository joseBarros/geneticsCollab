...
public class NLPModelResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<NLPModelDTO>> getAllNLPModels(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of NLPModels");
        Page<NLPModelDTO> page = nLPModelService.findAll(pageable);

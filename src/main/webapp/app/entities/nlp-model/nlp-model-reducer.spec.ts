...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './nlp-model.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NLPMODEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_NLPMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NLPMODEL actions', async () => {
      const expectedActions = [
        {

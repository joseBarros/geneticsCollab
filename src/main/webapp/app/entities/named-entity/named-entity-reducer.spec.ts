...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NAMEDENTITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_NAMEDENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NAMEDENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NAMEDENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NAMEDENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NAMEDENTITY actions', async () => {
      const expectedActions = [
        {
